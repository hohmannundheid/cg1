...
SceneController.prototype.setupClock = function() {
...
SceneController.prototype.setupLight = function()
{
    ...
    this.light.add(new THREE.Mesh(lightGeometry, lightMat));
    this.light.position.set(this.params.lightX, this.params.lightY, this.params.lightZ);
    this.scene.add(this.light);

    this.light2 = new THREE.PointLight(0xffffcc, 1, 100);
    this.light2.position.set(10, -30, -15);
...
SceneController.prototype.updateModel = function()
{
    ...
    this.light.position.x = this.params.lightX;
    this.light.position.y = this.params.lightY;
    this.light.position.z = this.params.lightZ;
    this.uniforms.lightPosition.value = this.light.position;
    this.render();
}
