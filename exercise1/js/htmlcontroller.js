...
HtmlController.prototype.onDocumentMouseDown = function(event)
{
    ...
    console.log("mouse down at " + event.x + " / " + event.y + " with button " + event.button);
...
HtmlController.prototype.onDocumentKeyDown = function(event) {
    ...
    switch(keyCode)
    {
        ...
        case "r": // r
            ...
            break;
        case "w":
            this.sceneController.selectChild(false);
            break;
        case "a":
            this.sceneController.selectSibling(false);
            break;
        case "s":
            this.sceneController.selectChild(true);
            break;
        case "d":
            this.sceneController.selectSibling(true);
            break;
        case "r":
            this.sceneController.reset();
            break;
